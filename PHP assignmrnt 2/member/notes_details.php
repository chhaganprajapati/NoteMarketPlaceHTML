                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12" id="notes-details-left">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 col-4">
                                <img src="<?php echo empty($display_picture) ? '../images/front/computer-science.png' : '../images/uploads/display_pictures/'.$display_picture;?>" class="img-fluid" alt="display picture">
                            </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-12" id="notes-details-right">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-7 text-right data"><?php echo $institute_name;?></div>
                            
                            <div class="col-md-6 col-6 label">Country:</div>      
                            <div class="col-md-6 col-6 text-right data"><?php echo $country;?></div>
                            
                            <div class="col-md-6 col-5 label">Course Name:</div>      
                            <div class="col-md-6 col-7 text-right data"><?php echo $course_name;?></div>

                            <div class="col-md-6 col-6 label">Course Code:</div>      
                            <div class="col-md-6 col-6 text-right data"><?php echo $course_code;?></div>

                            <div class="col-md-6 col-5 label">Professor:</div>      
                            <div class="col-md-6 col-7 text-right data"><?php echo $professor;?></div>

                            <div class="col-md-6 col-6 label">Number of Pages:</div>      
                            <div class="col-md-6 col-6 text-right data"><?php echo $no_of_pages;?></div>

                            <div class="col-md-6 col-6 label">Approved Date:</div>      
                            <div class="col-md-6 col-6 text-right data"><?php echo $approved_date;?></div>
