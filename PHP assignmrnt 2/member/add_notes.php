                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Title *</label>
                                <input type="text" class="form-control" name="title" placeholder="Enter your notes title" value="<?php echo isset($title) ? $title : '' ?>" <?php echo isset($note_id) ? 'readonly' : '' ?> required>
